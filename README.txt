This project was made for WGU C950 using Python. It is a package delivery simulator that is used to ensure that a batch of packages will be delivered by their individual deadlines. The prompt for the project was: 
...
It uses a terminal UI for user input, and uses a greedy nearest neighbor algorithm to determine an effective route for delivering packages.